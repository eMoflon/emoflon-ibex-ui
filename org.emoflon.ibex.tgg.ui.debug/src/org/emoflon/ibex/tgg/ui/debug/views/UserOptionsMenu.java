...
public class UserOptionsMenu {
	...
	edgeLabelAbbrRadioButton.setSelection(userOptionsManager.getEdgeLabelVisualization() == VisualizationLabelOptions.ABBREVIATED);
	...
	edgeLabelFullRadioButton.setSelection(userOptionsManager.getEdgeLabelVisualization() == VisualizationLabelOptions.FULLNAME);
	...
	corrLabelAbbrRadioButton.setSelection(userOptionsManager.getCorrLabelVisualization() == VisualizationLabelOptions.ABBREVIATED);
	...
	corrLabelFullRadioButton.setSelection(userOptionsManager.getCorrLabelVisualization() == VisualizationLabelOptions.FULLNAME);
	...
	nodeLabelAbbrRadioButton.setSelection(userOptionsManager.getNodeLabelVisualization() == VisualizationLabelOptions.ABBREVIATED);
	...
	nodeLabelFullRadioButton.setSelection(userOptionsManager.getNodeLabelVisualization() == VisualizationLabelOptions.FULLNAME);
