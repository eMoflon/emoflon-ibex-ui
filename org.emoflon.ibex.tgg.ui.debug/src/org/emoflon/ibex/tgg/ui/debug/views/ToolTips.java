...
public enum ToolTips {
	USEROPTION_NEIGHBORHOODSIZE(
			"Set number of connected neighboring elements to show", 
	...
	USEROPTION_SHOW_ELEMENTS(
			"Choose which elements of the graphs to show",
	...
	USEROPTION_LABEL_STYLE(
			"Choose whether to show full names, abbreviated names, or none",
	...
	MATCHDISPLAY_USEROPTION_BUTTON(
			"Open menu to select visualization options",
			"Opens a menu in which you can change the graph visualization."
			
	),
	MATCHDISPLAY_TERMINATE_BUTTON(
			"Close the debugger",
			"Clicking this button will close the debugger"
	),
	MATCHDISPLAY_RESTART_BUTTON(
			"Close and restart the debugger",
			"Close and restart the debugger to start the process again from the initial models"
	),
	MATCHDISPLAY_SAVE_MODELS_BUTTON(
	...
	MATCHDISPLAY_IMAGECONTAINER(
			"Visualization of the elements selected on the left",
	...
	MATCHLIST_APPLY_BUTTON(
			"Applies the selected rule or match.",
	...
	MATCHLIST_COLLAPSE_BUTTON(
			"Collapses all tree elements."
	),
	MATCHLIST_EXPAND_BUTTON(
			"Expands all tree elements."
	),
	PROTOCOL_VIEW(
			"List of previous rule applications.",
