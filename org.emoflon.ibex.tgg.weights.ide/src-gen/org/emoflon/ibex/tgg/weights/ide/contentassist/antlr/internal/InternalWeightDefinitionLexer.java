...
public class InternalWeightDefinitionLexer extends Lexer {
	...
	public final void mRULE_HEX() throws RecognitionException {
		try {
			int _type = RULE_HEX;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalWeightDefinition.g:18138:10: ( ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+ ( '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) ) )? )
			// InternalWeightDefinition.g:18138:12: ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+ ( '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) ) )?
			{
			// InternalWeightDefinition.g:18138:12: ( '0x' | '0X' )
			int alt1=2;
			...
			switch (alt1) {
				case 1 :
					// InternalWeightDefinition.g:18138:13: '0x'
					{
					match("0x"); 
					...
					break;
				case 2 :
					// InternalWeightDefinition.g:18138:18: '0X'
					{
					match("0X"); 
			...
			// InternalWeightDefinition.g:18138:24: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+
			int cnt2=0;
			loop2:
			while (true) {
				int alt2=2;
			...
			// InternalWeightDefinition.g:18138:58: ( '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) ) )?
			int alt4=2;
			...
			switch (alt4) {
				case 1 :
					// InternalWeightDefinition.g:18138:59: '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) )
					{
					match('#'); 
					// InternalWeightDefinition.g:18138:63: ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) )
					int alt3=2;
					...
					switch (alt3) {
						case 1 :
							// InternalWeightDefinition.g:18138:64: ( 'b' | 'B' ) ( 'i' | 'I' )
							{
							...
							break;
						case 2 :
							// InternalWeightDefinition.g:18138:84: ( 'l' | 'L' )
							{
	...
	public final void mRULE_INT() throws RecognitionException {
		try {
			int _type = RULE_INT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalWeightDefinition.g:18140:10: ( '0' .. '9' ( '0' .. '9' | '_' )* )
			// InternalWeightDefinition.g:18140:12: '0' .. '9' ( '0' .. '9' | '_' )*
			{
			matchRange('0','9'); 
			// InternalWeightDefinition.g:18140:21: ( '0' .. '9' | '_' )*
			loop5:
			while (true) {
				int alt5=2;
	...
	public final void mRULE_DECIMAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalWeightDefinition.g:18142:14: ( RULE_INT ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT )? ( ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' ) | ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' ) )? )
			// InternalWeightDefinition.g:18142:16: RULE_INT ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT )? ( ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' ) | ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' ) )?
			{
			mRULE_INT(); 

			// InternalWeightDefinition.g:18142:25: ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT )?
			int alt7=2;
			...
			switch (alt7) {
				case 1 :
					// InternalWeightDefinition.g:18142:26: ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT
					{
					...
					// InternalWeightDefinition.g:18142:36: ( '+' | '-' )?
					int alt6=2;
			...
			// InternalWeightDefinition.g:18142:58: ( ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' ) | ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' ) )?
			int alt8=3;
			...
			switch (alt8) {
				case 1 :
					// InternalWeightDefinition.g:18142:59: ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' )
					{
					if ( input.LA(1)=='B'||input.LA(1)=='b' ) {
						input.consume();
					}
					...
					break;
				case 2 :
					// InternalWeightDefinition.g:18142:87: ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' )
					{
	...
	public final void mRULE_ID() throws RecognitionException {
		try {
			int _type = RULE_ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalWeightDefinition.g:18144:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' | '0' .. '9' )* )
			// InternalWeightDefinition.g:18144:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' | '0' .. '9' )*
			{
			// InternalWeightDefinition.g:18144:11: ( '^' )?
			int alt9=2;
			...
			// InternalWeightDefinition.g:18144:44: ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' | '0' .. '9' )*
			loop10:
			while (true) {
				int alt10=2;
	...
	public final void mRULE_STRING() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalWeightDefinition.g:18146:13: ( ( '\"' ( '\\\\' . |~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )? | '\\'' ( '\\\\' . |~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )? ) )
			// InternalWeightDefinition.g:18146:15: ( '\"' ( '\\\\' . |~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )? | '\\'' ( '\\\\' . |~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )? )
			{
			// InternalWeightDefinition.g:18146:15: ( '\"' ( '\\\\' . |~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )? | '\\'' ( '\\\\' . |~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )? )
			int alt15=2;
			...
			switch (alt15) {
				case 1 :
					// InternalWeightDefinition.g:18146:16: '\"' ( '\\\\' . |~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )?
					{
					match('\"'); 
					// InternalWeightDefinition.g:18146:20: ( '\\\\' . |~ ( ( '\\\\' | '\"' ) ) )*
					loop11:
					while (true) {
						int alt11=3;
						...
						switch (alt11) {
						case 1 :
							// InternalWeightDefinition.g:18146:21: '\\\\' .
							{
							match('\\'); 
							matchAny(); 
							}
							break;
						case 2 :
							// InternalWeightDefinition.g:18146:28: ~ ( ( '\\\\' | '\"' ) )
							{
					...
					// InternalWeightDefinition.g:18146:44: ( '\"' )?
					int alt12=2;
					...
					break;
				case 2 :
					// InternalWeightDefinition.g:18146:49: '\\'' ( '\\\\' . |~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )?
					{
					match('\''); 
					// InternalWeightDefinition.g:18146:54: ( '\\\\' . |~ ( ( '\\\\' | '\\'' ) ) )*
					loop13:
					while (true) {
						int alt13=3;
						...
						switch (alt13) {
						case 1 :
							// InternalWeightDefinition.g:18146:55: '\\\\' .
							{
							match('\\'); 
							matchAny(); 
							}
							break;
						case 2 :
							// InternalWeightDefinition.g:18146:62: ~ ( ( '\\\\' | '\\'' ) )
							{
							if ( (input.LA(1) >= '\u0000' && input.LA(1) <= '&')||(input.LA(1) >= '(' && input.LA(1) <= '[')||(input.LA(1) >= ']' && input.LA(1) <= '\uFFFF') ) {
								input.consume();
							}
					...
					// InternalWeightDefinition.g:18146:79: ( '\\'' )?
					int alt14=2;
	...
	public final void mRULE_ML_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalWeightDefinition.g:18148:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// InternalWeightDefinition.g:18148:19: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// InternalWeightDefinition.g:18148:24: ( options {greedy=false; } : . )*
			loop16:
			while (true) {
				int alt16=2;
				...
				switch (alt16) {
				case 1 :
					// InternalWeightDefinition.g:18148:52: .
					{
					matchAny(); 
					}
					break;
	...
	public final void mRULE_SL_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalWeightDefinition.g:18150:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
			// InternalWeightDefinition.g:18150:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
			{
			match("//"); 

			// InternalWeightDefinition.g:18150:24: (~ ( ( '\\n' | '\\r' ) ) )*
			loop17:
			while (true) {
				int alt17=2;
			...
			// InternalWeightDefinition.g:18150:40: ( ( '\\r' )? '\\n' )?
			int alt19=2;
			...
			switch (alt19) {
				case 1 :
					// InternalWeightDefinition.g:18150:41: ( '\\r' )? '\\n'
					{
					// InternalWeightDefinition.g:18150:41: ( '\\r' )?
					int alt18=2;
	...
	public final void mRULE_WS() throws RecognitionException {
		try {
			int _type = RULE_WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalWeightDefinition.g:18152:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
			// InternalWeightDefinition.g:18152:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
			{
			// InternalWeightDefinition.g:18152:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
			int cnt20=0;
			loop20:
	...
	public final void mRULE_ANY_OTHER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalWeightDefinition.g:18154:16: ( . )
			// InternalWeightDefinition.g:18154:18: .
			{
			matchAny(); 
			}
