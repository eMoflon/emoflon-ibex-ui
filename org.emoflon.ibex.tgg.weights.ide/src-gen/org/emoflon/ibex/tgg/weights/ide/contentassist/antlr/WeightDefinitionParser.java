 ...
 */
package org.emoflon.ibex.tgg.weights.ide.contentassist.antlr;
...
import org.emoflon.ibex.tgg.weights.ide.contentassist.antlr.internal.InternalWeightDefinitionParser;
import org.emoflon.ibex.tgg.weights.services.WeightDefinitionGrammarAccess;

public class WeightDefinitionParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(WeightDefinitionGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, WeightDefinitionGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getHelperFuntionAccess().getGroup_5_1(), "rule__HelperFuntion__Group_5_1__0");
			builder.put(grammarAccess.getHelperFuncParameterAccess().getGroup(), "rule__HelperFuncParameter__Group__0");
			...
			builder.put(grammarAccess.getWeightDefinitionFileAccess().getWeigthDefinitionsAssignment_1(), "rule__WeightDefinitionFile__WeigthDefinitionsAssignment_1");
			builder.put(grammarAccess.getWeightDefinitionFileAccess().getDefaultAssignment_2(), "rule__WeightDefinitionFile__DefaultAssignment_2");
			builder.put(grammarAccess.getWeightDefinitionFileAccess().getHelperFuntionsAssignment_3(), "rule__WeightDefinitionFile__HelperFuntionsAssignment_3");
			...
			builder.put(grammarAccess.getHelperFuntionAccess().getParamsAssignment_5_0(), "rule__HelperFuntion__ParamsAssignment_5_0");
			builder.put(grammarAccess.getHelperFuntionAccess().getParamsAssignment_5_1_1(), "rule__HelperFuntion__ParamsAssignment_5_1_1");
			builder.put(grammarAccess.getHelperFuntionAccess().getBodyAssignment_7(), "rule__HelperFuntion__BodyAssignment_7");
			builder.put(grammarAccess.getHelperFuncParameterAccess().getParameterTypeAssignment_0(), "rule__HelperFuncParameter__ParameterTypeAssignment_0");
			builder.put(grammarAccess.getHelperFuncParameterAccess().getNameAssignment_1(), "rule__HelperFuncParameter__NameAssignment_1");
	...
	@Override
	protected InternalWeightDefinitionParser createParser() {
		InternalWeightDefinitionParser result = new InternalWeightDefinitionParser(null);
