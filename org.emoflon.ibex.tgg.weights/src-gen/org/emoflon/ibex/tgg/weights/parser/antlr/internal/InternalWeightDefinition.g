...
entryRuleWeightDefinitionFile returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getWeightDefinitionFileRule()); }
	iv_ruleWeightDefinitionFile=ruleWeightDefinitionFile
	{ $current=$iv_ruleWeightDefinitionFile.current; }
	EOF;

// Rule WeightDefinitionFile
ruleWeightDefinitionFile returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleRuleWeightDefinition returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRuleWeightDefinitionRule()); }
	iv_ruleRuleWeightDefinition=ruleRuleWeightDefinition
	{ $current=$iv_ruleRuleWeightDefinition.current; }
	EOF;

// Rule RuleWeightDefinition
ruleRuleWeightDefinition returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleDefaultCalculation returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getDefaultCalculationRule()); }
	iv_ruleDefaultCalculation=ruleDefaultCalculation
	{ $current=$iv_ruleDefaultCalculation.current; }
	EOF;

// Rule DefaultCalculation
ruleDefaultCalculation returns [EObject current=null]
@init {
	enterRule();
}
@after {
